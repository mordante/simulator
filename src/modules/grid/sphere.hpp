...
#ifndef MODULES_GRID_SPHERE_HPP_INCLUDED
#define MODULES_GRID_SPHERE_HPP_INCLUDED

/**
 * @file
 * Contains a function to create a sphere.
 *
...
/**
 * Calculates all points which form a sphere.
 *
 * This version draws the sphere around the origin. It does not remove the
 ...
 *
 * @returns                  The points that form the sphere.
 */
 ...
 * Calculates all points which form a sphere.
 *
 * This version draws the sphere around the origin and removes the duplicate
 * points.
 *
 * The algorithm is based on Bresenham's circle algorithm[1].
 *
 ...
 * Calculates all points which form a sphere.
 *
 * This version draws the sphere around @p centre and removes the duplicate
 * points.
 *
 * The algorithm is based on Bresenham's circle algorithm[1].
 *
 * [1] http://en.wikipedia.org/wiki/Bresenham%27s_circle_algorithm
 *
 * @param centre             The point marking the centre of the sphere.
 * @param radius             The radius of the sphere.
 * @param sorted_output      Sort the returned value. Certain algorithms expect
 *                           sorted ranges, for example
 *                           @ref grid::intersection, setting this value to
