...
#ifndef LIB_UTILITY_ENUMERATE_TPP_INCLUDED
#define LIB_UTILITY_ENUMERATE_TPP_INCLUDED
 ...
 *                                @code std::is_enum<T>::value == true @endcode
 *
...
#define ENUM_DECLARE_STREAM_OPERATORS(T)                                       \
	std::ostream& operator<<(std::ostream& lhs, const T rhs);                  \
                                                                               \
	static_assert(std::is_enum<T>::value, "The type T must be an enum type."); \
                                                                               \
	void operator<<(std::string& lhs, const T rhs);                            \
                                                                               \
	std::istream& operator>>(std::istream& lhs, T& rhs);                       \
                                                                               \
	void operator>>(const std::string& lhs, T& rhs);
 ...
 *
 * This defines the operators declared with @ref
 *ENUM_DECLARE_STREAM_OPERATORS.
